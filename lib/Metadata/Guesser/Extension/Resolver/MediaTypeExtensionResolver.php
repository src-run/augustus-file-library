...
final class MediaTypeExtensionResolver implements ExtensionResolverInterface
{
    ...
    {
        return isset($this->extensions[$file->getMediaType()->stringify()])
            ? ExtensionMetadata::create($this->extensions[$file->getMediaType()->stringify()])
            : null;
    }
}
